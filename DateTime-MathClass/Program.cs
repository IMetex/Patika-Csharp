...
namespace DateTime_MathClass
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Math Kütüphanesi
            Console.WriteLine(Math.Abs(-24)); //24
            ...
            Console.WriteLine(Math.Log(9)); // 9 un e tabanindaki logaritmik karşılığı
            Console.WriteLine(Math.Exp(3)); // e üzeri 3 ü verir.
            Console.WriteLine(Math.Log10(10)); // 10 sayısının logaritma 10 tabanındaki karşışığı
